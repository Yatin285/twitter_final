...
while True:
    user = api.get_user('YatinAr57644811')
    api.update_profile(name=f'yatin arora|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : yatin|{follower_count(user)} Followers')
